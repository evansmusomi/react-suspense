...
const LeftNav = React.lazy(() =>
  import('../suspense-list/left-nav').then(delay(500)),
)
const MainContent = React.lazy(() =>
  import('../suspense-list/main-content').then(delay(500)),
)
const RightNav = React.lazy(() =>
  import('../suspense-list/right-nav').then(delay(500)),
)
        ...
        >
          <React.SuspenseList revealOrder="forwards">
            <React.Suspense fallback={fallback}>
              <NavBar pokemonResource={pokemonResource} id={1} />
            </React.Suspense>
            <div className={cn.mainContentArea}>
              ...
              <React.Suspense fallback={fallback}>
                <MainContent pokemonResource={pokemonResource} id={3} />
              </React.Suspense>
              <React.Suspense fallback={fallback}>
                <RightNav pokemonResource={pokemonResource} id={4} />
              </React.Suspense>
            </div>
          </React.SuspenseList>
        </PokemonErrorBoundary>
